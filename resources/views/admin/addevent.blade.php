	...
	<div class="panel-body">
		<form action="{{ url('admin/createevent') }}" method="POST" class="form-horizontal" >
			...
			<div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
				...
				<div class="col-sm-6">
					<textarea  rows="5" cols="50" name="description" id="description" class="form-control" placeholder="description"> </textarea>
				</div>
			</div>
			...
			<div class="form-group{{ $errors->has('country') ? ' has-error' : '' }}">
				...
				<div class="col-sm-6">
					<input type="text" list="country" name="scountry" id="scountry"/>
				...
				<div class="form-group{{ $errors->has('long') ? ' has-error' : '' }}">
					...
					<div class="col-sm-6">
						<input type="text" name="long" id="lat" class="form-control" placeholder="long" >
					</div>
				</div>
			<div class="form-group{{ $errors->has('website') ? ' has-error' : '' }}">
				<label for="website" class="col-sm-3 control-label">website</label>
				<div class="col-sm-6">
					<input type="text" name="website" id="zip" class="form-control" placeholder="website">
				</div>
			</div>
